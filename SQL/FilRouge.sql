...
(NULL, CURRENT_TIMESTAMP, "cachet", "corentin", "cachet.corentin@monemail.com", "0987654321", "biroute", "toto", "urlavatar"),
(NULL, CURRENT_TIMESTAMP, "petit", "will", "legrand.petitwill@free.fr", "3165789865", "willfrite", "toto", "urlavatar"),
(NULL, CURRENT_TIMESTAMP, "dolphin", "mika", "mika.ledauphin@caramail.fr", "1565459845", "flipper", "toto", "urlavatar"),
(NULL, CURRENT_TIMESTAMP, "chamousse", "geronimus", "cham.gero@gmail.com", "3164169182", "jazounette", "toto", "urlavatar"),
(NULL, CURRENT_TIMESTAMP, "dipersio", "anthony", "anto.diper@gmail.com", "1265489845", "legrandtony", "toto", "urlavatar");
-- (NULL, CURRENT_TIMESTAMP, "", "", "", "", "", "toto", "urlavatar"),
-- (NULL, CURRENT_TIMESTAMP, "", "", "", "", "", "toto", "urlavatar");
...
(NULL, CURRENT_TIMESTAMP, 1, "PHP", "jy connais rien au PHP, de l'aide j'vous en supli", "hier j'ai essayé d'apprendre ce langage des enfers, mais j'ai rien compris", 0),
(NULL, CURRENT_TIMESTAMP, 2, "javascript", "de l'aide JPP", "le javascript c'est trop dur, je vais me pendre", 11),
(NULL, CURRENT_TIMESTAMP, 5, "c#", "au secour!!!!", "chui dans une formation dotnet, le formateur il me parle dans une langue que je ne comprend pas, help me please", 33),
(NULL, CURRENT_TIMESTAMP, 3, "htlm/css", "c'est quoi cette balise<prout>", "ya une balise <prout> dans mon code, je sais pas comment elle est arrivé là, j'arrive pas à l'enlever", 22),
(NULL, CURRENT_TIMESTAMP, 4, "java", "c'est quoi la différence avec le javascript?", "bah quoi! ya juste scrypt en plus, c'est pareil non?", 5),
(NULL, CURRENT_TIMESTAMP, 5, "java", "titre", "description", 1);
