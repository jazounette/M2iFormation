-- source /Codage/DotNet/CSharp/FilRouge/SQLSources/filrouge.sql;
...
(NULL, CURRENT_TIMESTAMP, 4, 3, FALSE, FALSE, "la balise prout, j'en peux plus, elle veut pas partir"),
...
(NULL, CURRENT_TIMESTAMP, 7, 5, FALSE, TRUE, "message");
